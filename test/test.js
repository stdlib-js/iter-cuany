...
tape( 'main export is a function', function test( t ) {
	...
	t.strictEqual( typeof iterCuAny, 'function', 'main export is a function' );
	t.end();
});
...
tape( 'if no upstream iterator values are truthy, the function returns an iterator protocol-compliant object which returns all falsy values', function test( t ) {
	var expected;
	var actual;
	var values;
	var it;
	...
	it = iterCuAny( array2iterator( values ) );
...
tape( 'if at least one upstream iterator value is truthy, the function returns an iterator protocol-compliant object which returns truthy values upon encountering the first truthy value', function test( t ) {
	var expected;
	var actual;
	var values;
	var it;
...
tape( 'if an environment supports `Symbol.iterator` and the provided iterator is iterable, the returned iterator is iterable', function test( t ) {
	...
	iterCuAny = proxyquire( './../lib/main.js', {
